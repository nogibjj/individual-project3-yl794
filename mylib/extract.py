...
load_dotenv()
server_h = "adb-6043605406637937.17.azuredatabricks.net"
access_token = "dapi74235b463b2257fc09800043b8fa561e-3"
...
def extract(
        ...
        file_path=FILESTORE_PATH+"/alcohol_consumption.csv",
